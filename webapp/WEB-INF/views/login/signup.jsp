                ...
                <div class="row" id="displayToggle">
                        ...
                        <section>
                            ...
                            <form class="form-horizontal" name="signup" id="signup">
                                <div class="form-group" id="IdCodeToggle">
                                    <label class="control-label col-sm-3">ID Code <span class="text-danger">*</span></label>
                                    <div class="col-md-8 col-sm-9">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="glyphicon glyphicon-credit-card"></i></span> <input type="text"
                                                class="form-control" name="id_code" id="id_code"
                                ...
                                <div class="form-group" id="guestIdCodeToggle" style="display:none;">
                                    ...
                                    <div class="col-md-8 col-sm-9">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i
                                                    class="glyphicon glyphicon-credit-card"></i></span> <input type="text"
                                                class="form-control" name="id_code_guest" id="id_code_guest"
                                                placeholder="Enter your ID_CODE(ID0000)" value="">
                                        </div>
                                    ...
                                    <div class="col-md-8 col-sm-9">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i
                                                ...
                                                class="form-control" name="id" id="id" placeholder="Enter your Email ID"
                                                value="">
                                        </div>
                                ...
                                <div class="form-group" id="guestPassToggle" style="display:none;">
                                    ...
                                    <div class="col-md-5 col-sm-8">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                            <input type="password" class="form-control" name="guestPassword"
                                                id="guestPassword" placeholder="Choose password (5-15 chars) geust"
                                                value="">
                                        </div>
                                ...
                                <div class="form-group" id="guestCPassToggle" style="display:none;">
                                    ...
                                    <div class="col-md-5 col-sm-8">
                                        <div class="input-group">
                                            <span class="input-group-addon"><i class="glyphicon glyphicon-lock"></i></span>
                                            <input type="password" class="form-control" name="guestCPassword"
                                                id="guestCPassword" placeholder="Confirm your password guest" value="">
                                        </div>
                                ...
                                <div class="form-group" id="idUseToggle">
                                    <label class="control-label col-sm-3" style="padding-top:3px;">아이디 사용여부 <span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-8 col-sm-9">
                                        <label> <input id="id_use_yn" name="id_use_yn" type="radio" value="Y" checked> YES
                                        </label>     <label> <input id="id_use_yn" name="id_use_yn" type="radio" value="N">
                                            NO
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div id="guest_toggle">
                                            ...
                                            <div>
                                                <c:if test="${!empty empCodeList}">
                                                    <select name="emp_code" id="emp_code" class="form-control">
                                                        ...
                                                        <c:forEach var="empCodeList" items="${empCodeList}" varStatus="i">
                                                            <option value="${empCodeList.emp_code}">${empCodeList.emp_code}
                                                            </option>
                                                        </c:forEach>
                                                    </select>
                                                </c:if>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-5 col-sm-8">
                                            <input type="text" class="form-control" name="name" id="name"
                                                placeholder="Enter your Name here" value="" readonly>
                                            <div class="check_font" id="name_check"></div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-3">부서 <span class="text-danger">*</span></label>
                                        <div class="col-md-5 col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3">직급 <span class="text-danger">*</span></label>
                                        <div class="col-md-5 col-sm-8">
                                            <div class="form-inline">
                                    ...
                                    <div class="form-group">
                                        <label class="control-label col-sm-3">입사 년도 <span class="text-danger">*</span>
                                        </label>
                                        <div class="col-md-5 col-sm-8">
                                            <input type="date" class="form-control" name="join_date" id="join_date"
                                                placeholder="Enter your date(yyyymmdd)" value="2019-09-22" readonly>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label class="control-label col-sm-3" style="padding-top:0px;">Gender <span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-8 col-sm-9">
                                            <label> <input name="gender" type="radio" value="M" checked disabled> Male
                                            </label>     <label> <input name="gender" type="radio" value="F" disabled>
                                                Female
                                            </label>
                                        </div>
                                    </div>
                                        ...
                                        <div class="col-md-5 col-sm-8">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i
                                                    ...
                                                    class="form-control" name="phone" id="phone" placeholder="Enter you
    													r Primary contact no." value="" readonly>
                                            </div>
                    ...
                    <div class="col-md-4">
                        <div style="margin-top:20px;">
                            ...
                            <input id="toggleP" type="checkbox" checked data-toggle="toggle" data-on="NORMAL"
                                data-off="GUEST" data-onstyle="info">
                        </div>
                    </div>
