        ...
        $(".deleteApply")
            .click(
                function () {
                    ...
                    location.href = "/login/employee/applyforvacation/delete?va_code=" + va_code;
                });
        ...
        <div class="card">
            ...
            <div class="form-group">
                ...
                <div class="tablebox">
                    ...
                    <button type="button" class="btn btn-secondary btn-apply" id="createBtn" data-toggle="modal"
                        data-target="#exampleModal" color="#e9ecef">휴가 신청</button>
                            ...
                            <c:forEach items="${applyList }" var="list">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <c:choose>
                                            ...
                                            <c:when test="${vs_code_name eq '반려'}">
                                                <button class="btn btn-outline-secondary no" id="${list.va_code }"
                                    ...
                                    <td>
                                        <c:choose>
                                            <c:when test="${vs_code_name eq '대기'}">
                                                <button name="delete" type="button" id="${list.va_code }"
