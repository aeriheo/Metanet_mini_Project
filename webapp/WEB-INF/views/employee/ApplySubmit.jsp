        ...
        <form role="form" class="form-horizontal applyform" id="applyform" name="applyform" method="post">
            ...
            <div class="form-group">
                ...
                <div class="form-group-div" style="width: 200px">
                    ...
                    <input type="text" id="year" name="va_year" size="10" value="<c:out value="
                        ${today}" />"placeholder="2019"
            ...
            <div class="form-group">
                ...
                <div class="form-group-div">
                    <select class="form-control" name="vk_code" id="vk_code" onchange="SetSelectBox();"
                        style="width: 150px">
            ...
            <div class="form-group">
                <label class="control-label col-sm-3">휴가기간 <span class="text-danger">*</span></label>
            ...
            <div class="form-group">
                ...
                <div class="form-group-div">
                    <input class="form-control" type="text" id="va_days_num" name="va_days_num" style="width: 300px;"
                        placeholder="Date" />
                </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group-div">
                    <input class="form-control" type="text" id="holiday" name="holiday" style="width: 300px;"
                        placeholder="Holiday" />
                </div>
            </div>

            <div class="form-group">
                <label class="control-label col-sm-3">휴가사유<span class="text-danger"> *</span></label>
