            ...
            <div class="card">
                <div style="width: 100%">
                    <div>
                        ...
                        <div class="btnSave">
                            <button class="btn btn-outline-secondary" type="button" id="annualBtn"
                                style="margin: 15px;">일괄 부여</button>
                        </div>
                        <div class="tableBox">
                            <form action="/login/vmanager/vmanagelist/update" method="post">
                                <table class="table" id="aTable">
                                    <thead class="thead-light">
                                        <tr>
                                            <th>
                                                <input type="checkbox" name="check_all" value="checkbox" id="check_all"
                                                    onclick="checkall();" /> <br />
                                            </th>
                                    ...
                                    <tbody>
                                        <c:forEach items="${vmAnnual}" var="list2">
                                            <tr id="vacation">
                                                ...
                                                <td>
                                                    <button name="modify" class="btn btn-outline-secondary"
